                    ...
                    <div className="swiper-wrapper">
                                            ...
                                            <div className="hero-content">
                                                ...
                                                <div className="hero-button" data-animation="fadeInUp" data-delay="1.5s">
                                                    <a href="contact.html" className="theme-btn">
                                                        Join With Us <i className="fa-solid fa-arrow-right-long"></i>
                                                    </a>
                        ...
                        <div className="swiper-slide">
                            <div className="hero-1">
                                ...
                                <div
                                    className="hero-bg bg-cover"
                                    style={{ backgroundImage: "url(assets/img/home-1/hero/hero-bg-2.jpg)" }}
                                ></div>
                                <div className="container">
                                    <div className="row g-4 justify-content-center">
                                        <div className="col-lg-10">
                        ...
                        <div className="swiper-slide">
                            <div className="hero-1">
                                ...
                                <div
                                    className="hero-bg bg-cover"
                                    style={{ backgroundImage: "url(assets/img/home-1/hero/hero-bg-3.jpg)" }}
                                ></div>
                                <div className="container">
                                    <div className="row g-4 justify-content-center">
                                        <div className="col-lg-10">
