    ...
    fetch("http://localhost:8000/api/v1/category_post")
      ...
      .then((data) => {
        ...
        const catWithCount = categoriesData.map((cat) => {
          const count =
            cat.posts?.filter((p) => p.language === currentLang).length || 0;
          const displayCount =
            count === 0
              ? currentLang === "bn"
                ? "০০"
  ...
  if (!post) {
    return (
      <div className="container py-5 text-center">
        <h2>
          {currentLang === "bn" ? "পোস্ট পাওয়া যায়নি" : "Post not found"}
        </h2>
                  ...
                  <div className="news-details-content">
                    ...
                    {post.tags && post.tags.length > 0 && (
                      <div className="row tag-share-wrap mt-4 mb-5">
                        ...
                        <div className="col-lg-4 col-12 mt-3 mt-lg-0 text-lg-end">
                          <div className="social-share d-flex justify-content-lg-end gap-3">
                            <a
                    ...
                    {post.comments && post.comments.length > 0 && (
                      <div className="comment-area">
                        <h3>
                          {formatCommentCount(post.comments.length)} Comments
                        </h3>
